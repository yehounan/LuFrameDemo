package com.yezi.jylframe.helper;
...
public class StringHelper {
    ...
    public static void validate_notNullOrWhitespace(String value, String errorMessage) throws Exception {
        if (StringHelper.isNullOrWhitespace(value)) {
            throw new Exception("字符串为空");
        }
    }

    public static void validate_phoneNumber(String value, String errorMessage) throws Exception {
